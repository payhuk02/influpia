...
import { LayoutDashboard, Users, Megaphone, Scale, LogOut, Settings, ScrollText } from "lucide-react";
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // Source de vérité : table user_roles via la fonction SECURITY DEFINER has_role()
